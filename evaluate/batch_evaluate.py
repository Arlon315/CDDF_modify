...
def get_project_defaults() -> Mapping[str, object]:
    return {
        "datasets": {
            ...
            "M3FD_Fusion": {
                "ir_dir": os.path.expanduser(r"~/rivermind-data/dataSets/M3FD_Fusion/Ir"),
                "vis_dir": os.path.expanduser(r"~/rivermind-data/dataSets/M3FD_Fusion/Vis"),
                "num_pairs": 300,
            },
            "MSRS-main": {
        ...
        "default_model_path": "models/SM_MCAM_CrossHTB_HTB/_spatial_mamba_htb_cga_windowMCAM_CrossHistogramFMEM_06-15-05-52_epoch_090.pth",
